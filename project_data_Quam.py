...
dtypes_dict = {'centroid_lat': object,
               'centroid_long': object}

new_xref = pd.read_csv("./data/new_xref.csv", dtype=dtypes_dict)

final_lat_long_code_dict = {(lat, long):code for lat, long, code in zip(new_xref.centroid_lat, new_xref.centroid_long, new_xref.Monit_MAP_CODE1)}
